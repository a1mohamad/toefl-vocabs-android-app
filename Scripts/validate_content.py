...
Why this exists
---------------
There is no local Android SDK and no local emulator on this project, so the
normal "just run it and see" loop costs a full CI round trip. The single most likely
...
ASSETS_DIR = REPO_ROOT / "app" / "src" / "main" / "assets" / "VocabData"
VOCABS_PATH = ASSETS_DIR / "vocabs.json"
